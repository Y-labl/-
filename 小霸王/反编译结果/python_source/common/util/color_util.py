...
def culNewMobileXOffsetParse error at or near `LOAD_GLOBAL' instruction at offset 0
...
def isShowRoleAvatarParse error at or near `LOAD_GLOBAL' instruction at offset 0
...
def isLineColorParse error at or near `LOAD_FAST' instruction at offset 0
